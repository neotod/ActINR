...
class AdaptiveLinearWithChannel(nn.Module):
    ...
    def __init__(self, input_size, output_size, channel_size,
        ...
        self.rff = rff.layers.GaussianEncoding(sigma=5.0,input_size=1,encoded_size=40)
        ...
        #self.t_enc = PositionalEncoding('1.05_20',n_chunks=w_nchan)
...
class AdaptiveMultiGabor2DLayer(nn.Module):
    ...
    def __init__(self, in_features, out_features, n_channels,
        ...
        self.scale_0 = scale_0 #nn.Parameter(scale_0*torch.ones(1),True)
